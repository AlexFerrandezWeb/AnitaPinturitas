...
Asegura que la declaración XML esté SIEMPRE al principio
"""

import json
from datetime import datetime

def generar_meta_rss_final():
    # Cargar productos
    ...
    # Escribir archivo - SIN BOM para evitar problemas
    with open('facebook-feed-final.xml', 'w', encoding='utf-8') as f:
        f.write(rss_content)
    ...
    print("✅ Sin BOM para evitar problemas de servidor")

if __name__ == "__main__":
    generar_meta_rss_final()