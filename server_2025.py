...
def test():
    return jsonify({
        'status': 'ok', 
        'message': 'SERVIDOR 2025 funcionando correctamente',
        'version': 'server-2025-v2',
        'timestamp': '2025-01-27-16:00',
        'server': 'server_2025.py'
    })
...
def pagar_ahora_2025():
    try:
        print("🚀 SERVIDOR 2025 /pagar-ahora-2025 - Sin automatic_payment_methods")
        ...
        print(f"🚀 SERVIDOR 2025 /pagar-ahora-2025 - Sesión creada exitosamente: {session.id}")
